...
image_dir = r"D:/New folder/images"
metadata_path = r"D:/New folder/spiral.xlsx"

if not os.path.exists(image_dir):
    raise FileNotFoundError("Image folder not found! Please place PNG images inside dataset/spiral")

if not os.path.exists(metadata_path):
    raise FileNotFoundError("Spiral_metadata.csv not found!")
...
if not features:
    raise ValueError("No image features extracted. Ensure filenames in CSV match .png files in dataset/spiral/")
